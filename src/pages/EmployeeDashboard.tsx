    ...
    <div className="p-8 space-y-8 max-w-6xl mx-auto">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Link
            id="create-goal-btn"
            to="/goals/new"
            className="flex items-center gap-2 px-4 py-2.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          ...
          <p className={cn("text-3xl font-bold", totalWeightage === 100 ? "text-blue-600" : "text-amber-500")}>
            {totalWeightage}%
          </p>
          <p className={cn(
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          ...
          <p className="text-3xl font-bold text-indigo-600 uppercase font-display italic tracking-tighter">Drafting</p>
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden min-h-[400px] flex flex-col">
        <div className="p-5 border-b border-slate-100 flex items-center justify-between bg-white sticky top-0 z-10">
          ...
          <Link to="/goals/new" className="text-[10px] font-bold text-blue-600 uppercase tracking-widest hover:underline">
            + New Goal
          </Link>
        </div>
                ...
                goals.map((goal) => (
                  <tr key={goal.id} className="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-5 py-4 text-right whitespace-nowrap">
                      <button className="text-slate-400 hover:text-blue-600 p-1.5 hover:bg-blue-50 rounded-lg transition-all group-hover:translate-x-1">
