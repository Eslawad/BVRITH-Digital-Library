              ...
              >
                ...
                <div className="flex items-center gap-4 relative z-10">
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 px-8 py-4 bg-slate-950 text-white font-black rounded-2xl hover:bg-slate-900 transition-all shadow-xl shadow-slate-950/20 disabled:opacity-50 uppercase tracking-widest text-[11px]"
                  >
