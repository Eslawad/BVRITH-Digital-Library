  ...
  return (
    <div className="p-8 max-w-5xl mx-auto space-y-10">
        ...
        <div className="flex items-center gap-10">
          <div className="text-right">
            ...
            <p className={cn(
              ...
              totalWeightage === 100 ? "text-blue-600" : "text-amber-500"
            )}>
          ...
          <button
            ...
            disabled={saving}
            className="flex items-center gap-3 px-8 py-4 bg-slate-950 text-white font-black rounded-2xl hover:bg-slate-900 transition-all shadow-2xl shadow-slate-950/20 disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-widest text-[11px]"
          >
            {saving ? 'Transmitting...' : (
              <>
                Deploy Protocol
      ...
      <div className="space-y-8">
        <AnimatePresence initial={false}>
          {goalForms.map((form, index) => (
            <motion.div
              ...
              className="bg-white p-10 rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/40 relative overflow-hidden"
            >
              ...
              <div className="flex items-center justify-between mb-10 relative z-10">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-slate-950 text-white flex items-center justify-center font-black italic shadow-lg shadow-slate-950/20">
                    {index + 1}
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 relative z-10">
                <div className="space-y-3 md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-600 focus:bg-white transition-all font-bold text-slate-900 outline-none placeholder:text-slate-300 placeholder:italic"
                  />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <select
                    ...
                    className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-600 focus:bg-white outline-none transition-all font-bold text-slate-900 appearance-none"
                  >
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-600 focus:bg-white outline-none transition-all font-bold text-slate-900"
                    />
        ...
        <button
          onClick={addGoal}
          className="w-full py-12 border-4 border-dashed border-slate-200 rounded-3xl text-slate-300 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50/20 transition-all flex flex-col items-center justify-center gap-4 group"
        >
          <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all">
