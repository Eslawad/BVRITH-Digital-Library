    ...
    <div className="p-8 space-y-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          ...
          <Link to="/manager/approvals" className="text-[10px] text-blue-600 mt-2 font-bold uppercase hover:underline">Review Now</Link>
        </div>

        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Approved Goals</p>
          <p className="text-3xl font-bold text-blue-600">{approvedGoals.length.toString().padStart(2, '0')}</p>
          <p className="text-[10px] text-green-600 mt-2 flex items-center font-bold">
            <span className="inline-block w-2 h-2 rounded-full bg-green-500 mr-1.5"></span> On Schedule
          </p>
        </div>

        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          <p className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-1">Team Wellness</p>
          <p className="text-3xl font-bold text-indigo-600 uppercase font-display italic tracking-tighter">Optimal</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden flex flex-col min-h-[460px]">
            <div className="p-5 border-b border-slate-100 flex items-center justify-between">
              <h2 className="font-bold text-slate-900">Pending Goal Configurations</h2>
              <Link to="/manager/approvals" className="text-[10px] text-slate-400 font-bold uppercase tracking-widest hover:text-blue-600 transition-colors">Audit All</Link>
            </div>
            ...
            <div className="flex-1 overflow-auto divide-y divide-slate-100">
              {pendingApprovals.length === 0 ? (
                ...
                pendingApprovals.map(goal => (
                  <div key={goal.id} className="p-5 flex items-center justify-between hover:bg-slate-50 transition-colors group">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-xl bg-slate-950 flex items-center justify-center text-white font-black italic text-sm shadow-lg shadow-slate-950/20">
                    ...
                    <Link 
                      ...
                      className="p-2 text-slate-300 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-all group-hover:translate-x-1"
                    >
        ...
        <div className="space-y-6 flex flex-col">
          <div className="bg-slate-950 text-white rounded-2xl p-8 shadow-2xl shadow-slate-950/40 relative overflow-hidden flex-1">
            ...
            <h2 className="text-xs font-black uppercase tracking-[0.3em] mb-8 text-blue-400">
              Operations Center
            </h2>
            <div className="space-y-4">
              ...
              <button className="w-full text-center py-4 rounded-2xl bg-blue-600 hover:bg-blue-500 transition-all text-xs font-black uppercase tracking-[0.2em] mt-8 shadow-lg shadow-blue-600/20">
                Broadcast Update
              </button>
            </div>
          </div>
